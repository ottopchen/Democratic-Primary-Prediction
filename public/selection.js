...
function fillInModelOptions(resp) {
    ...
    addOption(selectTarget, ["Select Prediction Model", 0, "no-op"]);
...
function fillInSelectOptions(resp) {
    ...
    addOption(selectTarget, ["Select Distrct Demographic Display", 0, "no-op"]);
...
function selectChange(event) {
    ...
    document.getElementById("votes4").textContent="";
    document.getElementById("votes5").textContent="";
